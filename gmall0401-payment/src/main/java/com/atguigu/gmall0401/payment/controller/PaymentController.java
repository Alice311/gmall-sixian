...
public class PaymentController {
    ...
    @GetMapping("index") //重定向用GetMapping

			//orderId来自OrderServiceImpl saveOrder()
	...
	*/
        ...
        /*********组织参数*************
	getBody()返回页面submitHtml:最后return
		alipayClient.pageExecute(alipayRequest).getBody()：
		把上述参数形成了没有图形的表单，所有需要提交给支付宝的元素都在里面成为隐藏域
	submitHtml里的内容：所有的参数信息
	...
	****************************/
        ...
        //2  把提交操作保存起来：需要有一个数据库表payment_info
